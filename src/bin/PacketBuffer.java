...
import bin.nbt.CompressedStreamTools;
import bin.nbt.NBTSizeTracker;
...
//    }
    ...
    public String readStringFromBuffer(int maxLength)
    {
        ...
        if (i > maxLength * 4)
        {
        	System.err.println("The received encoded string buffer length is longer than maximum allowed (" + i + " > " + maxLength * 4 + ")");
        	return "The received encoded string buffer length is longer than maximum allowed (" + i + " > " + maxLength * 4 + ")";
        }
        else if (i < 0)
        {
        	System.err.println("The received encoded string buffer length is less than zero! Weird string!");
        	return "The received encoded string buffer length is less than zero! Weird string!";
        }
        else
        {
            ...
            {
            	System.err.println("The received string length is longer than maximum allowed (" + i + " > " + maxLength + ")");
            	return "The received string length is longer than maximum allowed (" + i + " > " + maxLength + ")";
            }
            else
            {
                return s;
    ...
    public ItemStack readItemStackFromBuffer() throws IOException
    {
        ...
        if (i >= 0)
        {
            ...
            itemstack.setCompoundTag(this.readNBTTagCompoundFromBuffer());
        }
    ...
    public PacketBuffer writeString(String string)
    {
        ...
        {
            System.err.println("String too big (was " + string.length() + " bytes encoded, max " + 32767 + ")");
            return null;
        }
        else
        {
