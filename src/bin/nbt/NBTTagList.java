...
public class NBTTagList extends NBTBase
{
    ...
    public void appendTag(NBTBase nbt)
    {
        if (nbt.getId() == 0)
        {
            System.err.println("Invalid TagEnd added to ListTag");
        }
        else
        {
            if (this.tagType == 0)
            ...
            {
            	System.err.println("Adding mismatching tag types to tag list");
                return;
            }
    ...
    public void set(int idx, NBTBase nbt)
    {
        ...
        {
        	System.err.println("index out of bounds to set tag in tag list");
        }
    }
