...
public class NBTTagCompound extends NBTBase
{
    ...
    public byte[] getByteArray(String key)
    {
        ...
        {
            throw new ClassCastException(this.createCrashReport(key, 7, classcastexception));
        }
    }
    ...
    public int[] getIntArray(String key)
    {
        ...
        {
            throw new ClassCastException(this.createCrashReport(key, 11, classcastexception));
        }
    }
    ...
    public NBTTagCompound getCompoundTag(String key)
    {
        ...
        {
            throw new ClassCastException(this.createCrashReport(key, 10, classcastexception));
        }
    }
    ...
    public NBTTagList getTagList(String key, int type)
    {
        ...
        {
            throw new ClassCastException(this.createCrashReport(key, 9, classcastexception));
        }
    }
    ...
    {
        String crashreport = ex + "Reading NBT data";
        String crashreportcategory = "Corrupt NBT tag";
        
        crashreportcategory.concat("Tag name: " +  key);
        return crashreport;
    }
    ...
    static NBTBase readNBT(byte id, String key, DataInput input, int depth, NBTSizeTracker sizeTracker) throws IOException
    {
        ...
        {
            String crashreport = ioexception + "Loading NBT data";
            String crashreportcategory = crashreport.concat(" NBT Tag ");
            crashreportcategory.concat(" Tag name: " + key);
            crashreportcategory.concat(" Tag type: " + Byte.valueOf(id));
            throw new IOException(crashreport);
        }
    }
